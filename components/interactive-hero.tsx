...
export default function InteractiveHero() {
  ...
  const handleContactClick = () => {
    toast({
      title: "Contact Info",
      description: "Email: thomasnynas59@gmail.com | Phone: (585) 304 2335",
      duration: 5000,
    })
  }
    ...
    <CustomGradientBackground className="min-h-[90vh]">
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            <TypewriterEffect
              text="Senior Full Stack Engineer and AI Software Engineer specializing in AI development, and scalable web applications."
