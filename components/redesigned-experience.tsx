...
const experiences = [
  {
    ...
    skills : ["Python","Django", "AI", "Data Engineering", "AWS", "Docker", "React", "Next.js"],
    metrics: [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Implemented AI-driven solutions, contributing to product innovation by integrating Data Engineering algorithms and improving data analysis capabilities.",
    ],
  ...
  // },
  {
    ...
    skills: ["Python", "Terraform", "Kubernetes", "AWS", "HuggingFace", "GPT-4", "FastAPI", "Docker", "GraphQL"],
    metrics: [
  ...
  //     "Integrated AI and Data Engineering for personalized learning and data analysis.",
